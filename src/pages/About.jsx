...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | Collaborative Construction Group</title>
        <meta name="description" content="Meet the team behind CCG. We specialise in fitness industry construction, commercial fit-outs, and tailored building solutions across NSW." />
      </Helmet>
