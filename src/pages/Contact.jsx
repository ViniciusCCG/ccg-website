...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Collaborative Construction Group</title>
        <meta name="description" content="Get in touch with our team to discuss your project. We’re here to provide expert advice and tailored construction solutions." />
      </Helmet>
